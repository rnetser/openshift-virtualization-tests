...
@pytest.fixture()
def drained_node(admin_client, vm_from_template_scope_class):
...
class TestEvictionStrategy:
    ...
    def test_hco_evictionstrategy_livemigrate_vm_no_evictionstrategy(
        ...
        check_migration_process_after_node_drain(client=unprivileged_client, vm=vm_from_template_scope_class)
