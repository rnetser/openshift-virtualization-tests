...
class TestWindowsTabletDevice:
    ...
    def test_windows_server_default_tablet_device(self, tablet_device_vm, admin_client):
    ...
    def test_windows_desktop_default_tablet_device(self, tablet_device_vm, admin_client):
