...
class TestWindowsHyperVFlags:
    ...
    def test_vm_hyperv_labels_on_launcher_pod(
        ...
        node_hyperv_labels = get_hyperv_enabled_labels(
            instance_labels=hyperv_vm.get_virt_launcher_pod(admin_client=admin_client).node.instance.metadata.labels
        )
    ...
    def test_vm_added_hyperv_features(
        ...
        vendor_id = hyperv_vm.get_xml_dict(admin_client=admin_client)["domain"]["features"]["hyperv"]["vendor_id"]
    ...
    def test_windows_vm_with_evmcs_feature(self, hyperv_vm, admin_client):
        verify_evmcs_related_attributes(vmi_xml_dict=hyperv_vm.get_xml_dict(admin_client=admin_client))
...
class TestFedoraHyperVFlags:
    ...
    def test_fedora_vm_with_evmcs_feature(self, hyperv_vm, admin_client):
        ...
        hyperv_vm_xml = hyperv_vm.get_xml_dict(admin_client=admin_client)
