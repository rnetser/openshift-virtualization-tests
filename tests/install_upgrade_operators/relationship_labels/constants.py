...
STORAGE_STR = "storage"
NETWORK_STR = "network"
MIGRATION_STR = "migration"
AUTOPILOT_STR = "autopilot"
# labels keys
...
EXPECTED_VIRT_DEPLOYMENTS_LABELS_DICT_MAP = {
    ...
    KUBEVIRT_MIGRATION_OPERATOR: {
        MANAGED_BY_LABEL_KEY: MANAGED_BY_LABEL_VALUE_OLM,
        COMPONENT_LABEL_KEY: MIGRATION_STR,
        VERSION_LABEL_KEY: None,
        PART_OF_LABEL_KEY: HCO_PART_OF_LABEL_VALUE,
    },
    KUBEVIRT_MIGRATION_CONTROLLER: {
        MANAGED_BY_LABEL_KEY: KUBEVIRT_MIGRATION_OPERATOR,
        COMPONENT_LABEL_KEY: MIGRATION_STR,
        VERSION_LABEL_KEY: None,
        PART_OF_LABEL_KEY: HCO_PART_OF_LABEL_VALUE,
    },
    VIRT_PLATFORM_AUTOPILOT: {
        MANAGED_BY_LABEL_KEY: MANAGED_BY_LABEL_VALUE_OLM,
        COMPONENT_LABEL_KEY: AUTOPILOT_STR,
        VERSION_LABEL_KEY: None,
        PART_OF_LABEL_KEY: HCO_PART_OF_LABEL_VALUE,
    },
    VIRT_SYNCHRONIZATION_CONTROLLER: {
